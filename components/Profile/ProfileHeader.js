            ...
            <Grid.Row stretched>
              ...
              <List>
                  <List.Item>
                    ...
                    <List.Content as="h3" content={`${profile.occupation} at ${profile.company}`}/>
              </List.Item>

              <List.Item>
                    
                    <List.Content as="h3" content={`Attended ${profile.education}`}/>
              </List.Item>
              

              <List.Item>
                    <br/>
                    <List.Content content={profile.bio} style={{color: "#23305B"}}/>
              </List.Item>
              </List>
